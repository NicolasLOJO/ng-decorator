...
export class PlatformRef {
    static bootstrapModule(
        moduleType: NgModule | IModule | string,
        compilerOptions: CompilerOptions = { strictDi: false }
    ) {
        ...
        switch (typeof moduleType) {
            ...
            default: {
                ...
                if (!module) {
                    throw Error(
                        'Argument moduleType should be NgModule class, angular.module object or module name string'
                    );
                }
